  ...
  <div class="login-bg">
      ...
      <div class="screen-height">
        <div class="login-content">
          ...
          <el-card class="login-box">
            <el-image
                src="https://sso.wimoor.com/images/login/login-logo.png"
            ></el-image>
            ...
            <el-form class="m-t-24" ref="form" :model="form" size="normal">
              ...
              <el-form-item>
                <div class="flex-center-between" style="flex: 1">
                  ...
                  <el-button type="info" link @click="goResetPassword"
                  >忘记密码</el-button
                  >
                </div>
              </el-form-item>
    ...
    <el-affix position="bottom" :offset="20">
      <div class="text-center filing-number">
        ...
        >Copyright © 2017 广州八方全球电子商务贸易有限公司版权所有 |
          粤ICP备19045760号</span
        >
      </div>
    </el-affix>
    ...
    userLogin() {
      request.post("/api/auth/login", this.form).then((res) => {
        if (res.data) {
          ...
          if (path) {
            if (
                path.indexOf("auth/getJSession") > 0 ||
                path.indexOf("ssologin") > 0 ||
                path == "/" ||
                path == "/login"
            ) {
